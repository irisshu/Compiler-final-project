...
Type
        ...
        */
        ...
        | ARRAY_ '[' SimpleType EltType
          { $$ = make_array_type($3,$4); } //Iris add
        | RECORD_ FieldList END_
          { $$ = make_record_type($2); } //Iris add
        | RECORD_ END_
          { $$ =  0; } //$$ = 空指標，0是一個位址，不知道多長
        | '^' ID_
          { $$ = make_id_type($2); } // 用現有function，'^'是指標		  
        | error
          { $$ = the_err_type; }
        ;
...
FieldList
        ...
        */
        : ID_ ':' Type OptFieldList
          { $$ = make_fieldlist (make_field ($1, $3), $4); } //Iris add
        | ID_ ',' FieldList
...
ProcedureDeclaration
	    ...
	    */
          { $$ =  make_procfunc_decl ($2, $3, 0, $5); } //Iris add
        ;
		//iris: ProcedureDeclaration的 type 是 decl_
...
FunctionDeclaration
        ...
        /*
          ...
          Hint: You can read PROCFUNCDEF and DECL which pre-defined in struct.h. 
        */
          { $$ =  make_procfunc_decl ($2, $3, $5, $7); } //Iris add
        ;
...
CompoundStatement
        ...
        */
          { $$ = make_compound_stmt($2); } //Iris add
        ;
		// CompoundStatement 的 type 是 stmt_
...
Statements
        ...
        /*
          ...
          Implement the function in astree.c to handle this production.
        */
          { $$ = make_stmtlist($1, 0); } // Iris add
        | Statement ';' Statements
        /*
          Feature 6 (continue)
          Implement the function in astree.c to handle this production.
        */
          { $$ = make_stmtlist($1, $3); } //Iris add
        ;
